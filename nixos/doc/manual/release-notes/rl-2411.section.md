...
- NetBox was updated to `>= 4.0.0`.
  Have a look at the [breaking changes](https://github.com/netbox-community/netbox/releases/tag/v4.0.0),
  make the required changes to your database, if needed,
  then upgrade by setting `services.netbox.package = pkgs.netbox_4_0;`
